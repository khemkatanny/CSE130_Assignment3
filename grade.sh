...
echo "\
IMPORTANT: Getting a good grade for Cartman here does NOT mean you will \
in the grading system. Take great care to ensure your implementation is \
free of race conditions as they will almost certainly be promoted to \
deadlock in the grading system. "
echo ""
